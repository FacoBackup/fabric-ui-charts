...
import { ThemeContext, Button } from '@f-ui/core';
...
var DashboardContext = /*#__PURE__*/React.createContext({
  data: []
});
...
function useLineChart(_ref) {
  ...
  var xBefore, yBefore;
  var visibleValues = useMemo(function () {
...
function useCircleChart(_ref) {
  ...
  var coloredData = useMemo(function () {
...
function Visual(props) {
  ...
  var datasets = useContext(DashboardContext);
  ...
  }, props.title, values.length > 0 ? /*#__PURE__*/React.createElement("div", {
...
export { Dashboard, DashboardGroup, Sample, Visual, useSample };
